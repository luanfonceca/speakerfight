...
urlpatterns = (
    url(regex=r'/my_proposals/',
        ...
        name='my_proposals'),
    url(regex=r'/my_events/',
        view=views.ListMyEvents.as_view(),
        name='my_events'),
    url(regex=r'/events/',
        view=views.ListEvents.as_view(template_name='event/event_list.html'),
        name='list_events'),
    url(regex=r'/past_events/',
        view=views.ListEvents.as_view(
            template_name='event/past_event_list.html',
            past_events=True),
        name='past_events'),
    ...
    url(regex=r'/events/<slug:slug>/update/',
        ...
        name='update_event'),
    url(regex=r'/events/<slug:slug>/delete/',
        view=views.DeleteEvent.as_view(),
        name='delete_event'),
