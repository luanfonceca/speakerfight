...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proposal.is_published'
        db.add_column(u'deck_proposal', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposal.is_published'
        db.delete_column(u'deck_proposal', 'is_published')
